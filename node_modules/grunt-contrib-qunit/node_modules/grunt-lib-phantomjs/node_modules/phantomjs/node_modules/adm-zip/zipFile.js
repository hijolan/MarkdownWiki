var ZipEntry = require("./zipEntry"), Headers = require("./headers");
Utils = require("./util");

module.exports = function (/*Buffer*/buf) {
	var entryList = [], entryTable = {}, _comment = '', endHeader = new Headers.MainHeader();
	...
	function readEntries() {
		...
		for (var i = 0; i < entryList.length; i++) {
			...
			var tmp = index, entry = new ZipEntry();
	...
	return {
		...
		toBuffer: function () {
			...
			var totalSize = 0, data = [], header = [], dindex = 0;
